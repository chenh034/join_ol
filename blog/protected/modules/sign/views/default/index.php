			...
			<div class="announce">
				<div class="noticeboard">
					...
					<?php foreach ($announceInfo as $key => $value): ?>
						<a class="title" href="<?php echo $this->createUrl('/index/announce',array('id'=>$value->id)) ?>" target='_blank'>
				...
				<a class="enter" href="<?php echo $this->createUrl('announce/index') ?>">进入公告</a>
